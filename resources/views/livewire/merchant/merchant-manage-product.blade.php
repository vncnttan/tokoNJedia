<div class="w-full h-full flex flex-col justify-center items-center gap-8 p-8 lg:p-16 box-border overflow-y-auto bg-white">
    ...
    <div
        ...
        <div class="w-full p-4 ml-8 box-border flex justify-between items-center border-b-2 border-gray-100">
