<div class="relative h-96 overflow-hidden rounded-lg md:h-[50vh] group">
    <label class="relative group">
        ...
        <div class="group-hover:flex hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white p-2 w-full h-full bg-black bg-opacity-25 justify-center items-center">
        ...
        <img src="{{ $temporaryBannerImageUrl ?? $bannerImage ?? asset('assets/logo/banner-merchant.jpeg') }}"
