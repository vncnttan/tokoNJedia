    ...
    <div class="max-w-7xl w-full h-full flex flex-col justify-center items-center gap-8 p-8 box-border">
        ...
        <div class="w-full bg-white flex-grow shadow-container rounded-lg flex flex-col justify-start items-center p-10 gap-8">
            ...
            <div class="w-full flex justify-between items-center">
                ...
                <div class="w-full">
                    <input type="text" class="input-style w-full" placeholder="Example: Nike Man Shoes (Product Type/Category/Brand/Other)">
                </div>
            </div>
            <div class="w-full flex justify-between items-center">
                <div class="w-96 flex flex-col justify-start text-start items-center gap-2">
                ...
                <div class="w-full">
                    <div class="w-full ring-1 ring-gray-300 p-2 rounded-md">
