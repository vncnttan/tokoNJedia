<div class="w-full flex flex-col">
    <div class="w-full flex items-center gap-2 py-2 box-border">
        <svg class="icon-size" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" fill="#ffffff" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
            ...
            <div
                ...
                <form action="/profile/image" method="POST" enctype="multipart/form-data" class="w-full" id="fileUploadForm" >
                    ...
                    <label
                        ...
                        <input class="hidden" type="file" name="file" accept="image/jpeg, .jpeg, .jpg, image/png, .png" onchange="uploadFile()" >Choose
                        Image
                    </label>
                </form>
            ...
            <div class="flex-grow h-full flex flex-col">
                ...
                <div class="w-full h-full flex flex-col gap-8 text-sm text-black">
                    ...
                    <div class="w-full  flex items-center">
                        ...
                        @else
                            <button class="text-green-500" onclick="Livewire.emit('openModal', 'edit-dob-modal')">Input
                                Date of Birth</button>
                        @endif
                    </div>
                    <div class="w-full  flex items-center">
                        ...
                        @if (Auth::user()->gender != null)
                            ...
                            <button class="text-green-500"
                                onclick="Livewire.emit('openModal', 'edit-gender-modal')">Edit Gender</button>
                        @else
                            <button class="text-green-500"
                                onclick="Livewire.emit('openModal', 'edit-gender-modal')">Input Gender</button>
                        @endif
                    </div>
                    <div class="w-full  flex items-center">
                        ...
                        @else
                            <button class="text-green-500"
                                onclick="Livewire.emit('openModal', 'edit-phone-modal')">Input Phone Number</button>
                        @endif
                    </div>
                </div>
            </div>
