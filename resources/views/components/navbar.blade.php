<div class="relative h-32 w-full z-30">
    <div class="fixed top-0 left-0 right-0 bg-white border-b-2 border-solid border-gray-100 flex flex-col gap-2">
        ...
        <div class="w-full box-border flex flex-col py-2 lg:px-12 px-6 ">
            <div class="flex justify-between items-center lg:gap-8 gap-2 h-12">
                ...
                <div class="h-full hidden md:flex justify-center items-center lg:gap-4 gap-2 w-">
            ...
            <div class="xl:px-60 lg:px-12 hidden md:flex text-gray-500 lg:text-sm text-xs flex-row gap-4 py-1 ">
